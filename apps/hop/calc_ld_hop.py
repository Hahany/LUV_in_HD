...
Rc = 14.50
rh = 0.8
dt_list = [10, 50, 100, 200, 500, 1000, 2000, 25000, 5000, 10000, 50000, 100000]
# dt_list = [2000, 25000, 5000, 10000, 50000, 100000]
# dt_list = [25000]
...
for dt in dt_list:
    ...
    np.savetxt(f"{save_dir}/Rc_{Rc:.02f}_ld_hopped_dt_{dt}.txt",
